...
import { Header, Footer, AboutUsFirstBlock, AboutUsFourBlock, AboutUsSecondBlock, AboutUsThreeBlock, MainPageSevenBlock, MainPageThirdBlock, AboutUsSevenBlock, AboutUsSixBlockEye, MainPageSixBlock, MainPageEightBlock, MainPageTenBlock } from '../components';
