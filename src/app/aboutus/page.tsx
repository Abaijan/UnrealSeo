...
import { Header, Footer, AboutUsFirstBlock, OurTeam, AboutUsFourBlock, AboutUsSecondBlock, AboutUsThreeBlock, MainPageSevenBlock, MainPageThirdBlock, AboutUsSevenBlock, AboutUsSixBlockEye, MainPageSixBlock, MainPageEightBlock, MainPageTenBlock } from '../components';
